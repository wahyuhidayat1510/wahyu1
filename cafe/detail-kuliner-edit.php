            ...
            <div class="container">
				...
				<!DOCTYPE HTML>
					...
					if (mysqli_num_rows($result) > 0) {
						...
						?>
					<form action="detail-kuliner-edit-simpan.php?" method="get">
						<input type="hidden" name="id_kuliner" value='<?php echo $row["id_kuliner"]?>'><br>
					Nama Kuliner: <input type="text" name="nm_kuliner" value='<?php echo $row["nama_kuliner"]?>'><br>
					Alamat: <input type="text" name="alamat" value='<?php echo $row["alamat"]?>'><br>
					Pemilik: <input type="text" name="pemilik" value='<?php echo $row["pemilik"]?>'><br>
					Latitude: <input type="text" name="lt" value='<?php echo $row["latitude"]?>'><br>
					Longitude: <input type="text" name="lng" value='<?php echo $row["longitude"]?>'><br>
					Menu Andalan: <input type="text" name="menu" value='<?php echo $row["menu"]?>'><br>
					Jam Buka: <input type="text" name="jambuka" value='<?php echo $row["jam_buka"]?>'><br>
					Keterangan: <input type="text" name="keterangan" value='<?php echo $row["keterangan"]?>'><br>
					<input type="Submit" value="Simpan">
					</form>
					<div class="row">
            </div> 
					<h3><u><b><a href='datakuliner.php'>Lihat Data Kuliner</a></b></u></h3>
					<h3><u><b><a href='detail-kuliner-edit-hapus.php?id=<?php echo $row['id_kuliner']?>'>Hapus Data</a></b></u></h3>
					<?php
					   }
					} else {
