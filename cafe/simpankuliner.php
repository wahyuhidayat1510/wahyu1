...
<div class="page">
    ...
    <main>
       <section class="well">
            <div class="container">
				<a href="#"><h2><em>Masukkan Data Cafe</em></h2></a>
				<div class="row">
				</div>
				...
				<!DOCTYPE HTML>
					...
					<form action="simpankuliner.php" method="get">
					Nama Kuliner: <br><input type="text" name="nm_kuliner"><br>
					Alamat: <br> <input type="text" name="alamat"><br>
					Pemilik: <br><input type="text" name="pemilik"><br>
					Latitude: <br><input type="text" name="lt"><br>
					Longitude: <br><input type="text" name="lng"><br>
					Menu Andalan: <br> <input type="text" name="menu"><br>
					Jam Buka: <br><input type="text" name="jambuka"><br>
					Keterangan: <br><input type="text" name="keterangan"><br>
					<br><input type="Submit" value="Simpan">
					</form>
					<!--<h3><br><a href='data_kuliner2.php'>Kembali</a></h3>-->
					</body>
					</html>
					<br>  
											<?php
						...
						$sql = "INSERT INTO tb_kuliner 
									(nama_kuliner, alamat, pemilik, 
									latitude, longitude, menu, 
									jam_buka, keterangan)
								VALUES ('".$_GET['nm_kuliner']."',
									'".$_GET['alamat' ]."',
									'".$_GET['pemilik']."',
									'".$_GET['lt'     ]."',
									'".$_GET['lng'    ]."',
						...
						if (mysqli_query($conn, $sql)) {
							...
							echo "<h3><a href='datakuliner.php'>Lihat Data Cafe</a></h3>";
						} else {
