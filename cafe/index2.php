					...
					<li>
						...
						<ul role="menu" class="sub-menu">
										...
										<?php
											foreach($obj as $ob){
										?>
											<li><a class="dropdown-item" href="index2.php?id=<?php echo $ob->id_kuliner;?>"><?php echo $ob->nama_kuliner;?></a></li>
										<?php
											}
										?>
										</li>
            ...
            <div class="gallery">
			 ...
			 <div class="gallery">
                <div class="gallery_col-1">
                    ...
                    <a data-fancybox-group="gallery" href="images/hidangan5.jpg" class="gallery_item thumb lazy-img" style="padding-bottom: 94.6551724137931%;">
                        <img data-src="images/hidangan5.jpg" alt="">
                        <div class="gallery_overlay">
                            <div class="gallery_caption">
                                <p><em>Hidangan</em></p>
                                <p><em>MBS Bistro cafe</em></p>
                ...
                <div class="gallery_col-2">
                    <a data-fancybox-group="gallery" href="images/galeri4.jpg" class="gallery_item thumb lazy-img" style="padding-bottom: 52.48322147651007%;">
                        <img data-src="images/galeri4.jpg" alt="">
                        <div class="gallery_overlay">
                            <div class="gallery_caption">
                                <p><em>Kuliner</em></p>
                                <p><em>Waroeng Cafe 27</em></p>
                    ...
                    <a data-fancybox-group="gallery" href="images/galeri5.jpg" class="gallery_item thumb lazy-img" style="padding-bottom: 96.10738255033557%;">
                        <img data-src="images/galeri5.jpg" alt="">
                        <div class="gallery_overlay">
                            <div class="gallery_caption">
                                <p><em>Kuliner</em></p>
                                <p><em>MBS Bistro Cafe</em></p>
                ...
                <div class="gallery_col-3">
                    ...
                    <a data-fancybox-group="gallery" href="images/mbscafe.jpg" class="gallery_item thumb lazy-img" style="padding-bottom: 93.69676320272572%;">
                        <img data-src="images/mbscafe.jpg" alt="">
                        <div class="gallery_overlay">
                            <div class="gallery_caption">
                                <p><em>Tempat</em></p>
                                <p><em>MBS Bistro Cafe</em></p>
