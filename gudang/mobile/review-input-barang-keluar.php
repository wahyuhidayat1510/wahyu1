...
?>
	...
	<tr align="center">
		...
		<td bgcolor="#EEF2F7"><div align="center"><a href="index.php?page=form-input-barang-keluar">OK</a> | 
		<a href="index.php?page=delete-input-barang-keluar&id_tran_klr=<?=$id_tran_klr?>">Cancel</a></div></td>
	</tr>
	<tr align="center" bgcolor="#DFE6EF">
		<td>&nbsp;</td>
		<td>&nbsp;</td>
