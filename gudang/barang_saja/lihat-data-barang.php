...
<input type="button" value="TAmbah Data Barang" title="Tambah Data" onclick=window.open('form-input-master-barang.php','_blank');><br><br>
...
?>
	...
	<tr align="center">
		...
		<!--<a href="homegudang.php?page=edit-data-barang&kode_brg=<>?=$kode_brg?>">Edit</a> | <a href="homegudang.php?page=delete-data-barang&kode_brg=<>?=$kode_brg?>">Delete</a></div></td>
		-->
		<a href="edit-data-barang.php?kode_brg=<?=$kode_brg?>">Edit</a> | <a href="delete-data-barang.php?kode_brg=<?=$kode_brg?>">Delete</a></div></td>
