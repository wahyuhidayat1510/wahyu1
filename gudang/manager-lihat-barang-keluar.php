...
?>
<form action="homemanager.php?page=manager-lihat-barang-keluar" method="post" name="postform">
<p align="center"><font color="orange" size="3"><b>Laporan Barang Keluar</b></font></p><br />
	...
	<table border="0">
		<tr>
			...
			<td width="125"><b>Nama Picker</b></td>
			<td colspan="2" width="513">: <input type="text" name="pencarian" size="76" placeholder=" Isi Nama Pengambil Barang atau Picker"/></td>
			<td colspan="2" width="190"><input type="submit" value="Tampilkan Data Pencarian" name="cari_nama"/></td>
			<td colspan="2" width="70"><input type="reset" value="Reset" /></td>
		</tr>
	</table>
</form><br />
