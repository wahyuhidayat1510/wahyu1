...
if($_SESSION['level']!="Manager"){
    die("Anda bukan user Manager");//jika bukan admin jangan lanjut
}
?>
<html>
<head>
...
<tr bgcolor="#F8F8FF">
	...
	<td rowspan="4" valign="top"><table width="144" height="400" bgcolor="#B0C4DE" border="0" cellspacing="0" cellpadding="0" align="top">
		...
		<td valign="top"><ul class="navbar">
			...
			<li><a href="homemanager.php?page=manager-lihat-data-barang" title="lihat data barang">&nbsp;Data Barang</a></li>
			<li><a href="homemanager.php?page=manager-lihat-barang-masuk" title="laporan barang masuk">&nbsp;Barang Masuk</a></li>
			<li><a href="homemanager.php?page=manager-lihat-barang-keluar" title="laporan barang keluar">&nbsp;Barang Keluar</a></li>
		</ul></td>
		</tr></table></td>
	<td rowspan="4">&nbsp;</td>
	<td rowspan="4" valign="top"><table width="1136" height="400" bgcolor="white" border="0" cellspacing="0" cellpadding="0">
		<tr>
			...
			switch ($page) {
				case 'manager-lihat-data-barang' : include "manager-lihat-data-barang.php"; break;
				case 'manager-lihat-barang-masuk' : include "manager-lihat-barang-masuk.php"; break;
				case 'manager-lihat-barang-keluar' : include "manager-lihat-barang-keluar.php"; break;
